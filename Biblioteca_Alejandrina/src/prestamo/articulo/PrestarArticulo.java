/**====================================================================================
 * Archivo      : PrestarArticulo.java » Paquete: prestamo.articulo » Proyecto: Biblioteca_Alejandrina
...
public class PrestarArticulo implements ActionListener{
	...
	JLabel lblNombre,lblPApellido,lblSApellido,lblTelefono,lblCorreo,lblCategoria;
	JTextField txtNombre,txtPApellido,txtSApellido,txtTelefono,txtCorreo,txtCategoria;
	...
	public PrestarArticulo() {
		...
		txtPApellido.getDocument().addDocumentListener(
                new DocumentListener() {
                    public void changedUpdate(DocumentEvent e) {
                        filtroPApellido();
                    }
		...
		txtSApellido.getDocument().addDocumentListener(
                new DocumentListener() {
                    public void changedUpdate(DocumentEvent e) {
                        filtroSApellido();
                    }
		...
		txtTelefono.getDocument().addDocumentListener(
                new DocumentListener() {
                    public void changedUpdate(DocumentEvent e) {
                        filtroTelefono();
                    }
		...
		txtCorreo.getDocument().addDocumentListener(
                new DocumentListener() {
                    public void changedUpdate(DocumentEvent e) {
                        filtroCorreo();
                    }
		...
		txtCategoria.getDocument().addDocumentListener(
                new DocumentListener() {
                    public void changedUpdate(DocumentEvent e) {
                        filtroCategoria();
                    }
                ...
                new ListSelectionListener() {
                    public void valueChanged(ListSelectionEvent event) {
                        ...
                        if (event.getValueIsAdjusting()){
                        	if (table.getSelectedRow() != -1){ //Si la fila es -1 es porque se seleccionó el encabezado
...
//		grid.anchor=GridBagConstraints.LINE_END;
	...
	private void filtroNombre() {
        ...
        try {
            rf = RowFilter.regexFilter(txtNombre.getText(), 0); // (Patron a filtrar, int columna en la que quiero buscar) TODO patron para buscar
	...
	private void filtroPApellido() {
        ...
        //If current expression doesn't parse, don't update.
        try {
            rf = RowFilter.regexFilter(txtPApellido.getText(), 1); // (Patron a filtrar, int columna en la que quiero buscar) TODO patron para buscar
        } catch (java.util.regex.PatternSyntaxException e) {
            return;
        }
        sorter.setRowFilter(rf);
	...
	private void filtroSApellido() {
        ...
        //If current expression doesn't parse, don't update.
        try {
            rf = RowFilter.regexFilter(txtSApellido.getText(), 2); // (Patron a filtrar, int columna en la que quiero buscar) TODO patron para buscar
        } catch (java.util.regex.PatternSyntaxException e) {
            return;
        }
        sorter.setRowFilter(rf);
	...
	private void filtroTelefono() {
        ...
        //If current expression doesn't parse, don't update.
        try {
            rf = RowFilter.regexFilter(txtTelefono.getText(), 3); // (Patron a filtrar, int columna en la que quiero buscar) TODO patron para buscar
        } catch (java.util.regex.PatternSyntaxException e) {
            return;
        }
        sorter.setRowFilter(rf);
	...
	private void filtroCorreo() {
        ...
        //If current expression doesn't parse, don't update.
        try {
            rf = RowFilter.regexFilter(txtCorreo.getText(), 4); // (Patron a filtrar, int columna en la que quiero buscar) TODO patron para buscar
        } catch (java.util.regex.PatternSyntaxException e) {
            return;
        }
        sorter.setRowFilter(rf);
	...
	private void filtroCategoria() {
        ...
        //If current expression doesn't parse, don't update.
        try {
            rf = RowFilter.regexFilter(txtCategoria.getText(), 5); // (Patron a filtrar, int columna en la que quiero buscar) TODO patron para buscar
        } catch (java.util.regex.PatternSyntaxException e) {
            return;
        }
        sorter.setRowFilter(rf);
